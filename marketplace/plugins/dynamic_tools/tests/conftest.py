...
The plugin lives under ``marketplace/plugins/dynamic_tools/extension/``. The
...
_TESTS = Path(__file__).resolve().parent  # .../dynamic_tools/tests
_PLUGIN = _TESTS.parent  # .../dynamic_tools
_EXT = _PLUGIN / "extension"  # .../dynamic_tools/extension
...
for _name, _path in (
    ...
    ("marketplace.plugins.dynamic_tools", _PLUGIN),
):
...
_PKG = "marketplace.plugins.dynamic_tools.extension"
